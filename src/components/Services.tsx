...
const cardClassName =
  'bg-[#f8fafd] rounded-2xl md:rounded-lg p-5 md:p-8 shadow-sm md:shadow-none hover:shadow-md transition-shadow duration-300 border border-transparent hover:border-blue-100 flex flex-col h-full';

function ServiceCardBody({ service }: { service: Service }) {
  return (
    <>
      <div className="mb-4 md:mb-6">{service.icon}</div>
      <h3 className="text-base md:text-xl font-bold text-gray-900 mb-2 md:mb-3 leading-snug">
        {service.title}
      </h3>
      ...
      {service.href ? (
        <span className="mt-auto pt-4 text-sm font-semibold text-[#1E88E5]">
          Learn more →
        </span>
      ) : null}
    </>
...
function ServiceCard({
  ...
  return (
    <motion.div variants={variants} className={cardClassName}>
      {service.href ? (
  ...
  return (
    <section id="services" className="py-8 md:py-12 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Phone: title above + 2-column card grid */}
        ...
        {/* Desktop: ladder / staircase layout */}
        <motion.div
        ...
        >
          <div className="md:col-span-2 flex flex-col justify-center pr-8">
            <motion.h2
              variants={itemVariants}
              className="text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight mb-4"
            >
              Our IoT & Data <br /> capabilities
            </motion.h2>
            <motion.p
              variants={itemVariants}
          ...
          <ServiceCard service={services[0]} variants={itemVariants} />

          <div className="md:col-span-1" aria-hidden="true" />
          <ServiceCard service={services[1]} variants={itemVariants} />
          <ServiceCard service={services[2]} variants={itemVariants} />

          <ServiceCard service={services[3]} variants={itemVariants} />
          <ServiceCard service={services[4]} variants={itemVariants} />
          <ServiceCard service={services[5]} variants={itemVariants} />
        </motion.div>
      </div>
    </section>
  );
