      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-500 font-light max-w-3xl mx-auto">
            Ready to start your IoT journey? Contact us today to discuss your project 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#0B1C2D]">Address</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#0B1C2D]">Phone</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#0B1C2D]">Email</h4>
                    <p className="text-gray-600 text-sm mt-1">info@bitnbolt.com</p>
                    <p className="text-gray-600 text-sm">support@bitnbolt.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#0B1C2D]">Business Hours</h4>
            ...
            {/* Quick Contact */}
            <div className="bg-[#132A46] rounded-lg p-8 text-white border border-white/10">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span>Emergency: +1 (555) 999-8888</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
